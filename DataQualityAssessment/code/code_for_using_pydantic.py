...
class Duplicate(BaseModel):
    foundMatches: Optional[List[str]] = Field(
        None,
        description='If this is a duplicate, determine measurements it does match with',
    )
    isDuplicate: Optional[bool] = Field(
        None, description='Determine whether the measurement is duplicated or not'
    )
...
class Outlier(BaseModel):
    ...
    outlierScore: Optional[float] = Field(
        None, description='A score indicating the degree of outlierness'
    )
...
class DataQualityAssessment(BaseModel):
    ...
    completeness: Optional[confloat(ge=0.0, le=1.0)] = Field(
        None,
    ...
    dateCalculated: Optional[AwareDatetime] = Field(
        None, description='Date of the calculated entity defined by the user'
    )
    ...
    duplicate: Optional[Duplicate] = Field(
        None, description='Includes information about duplicated data'
    )
    id: Optional[
        Union[
            constr(
    ...
    outlier: Optional[Outlier] = Field(
        None,
    ...
    synthetic: Optional[Synthetic] = Field(
        None, description='Includes information about the origin of the measurement'
    )
    timeliness: Optional[float] = Field(
        None, description='Average timeliness of the data-stream'
    )
    type: Optional[Type6] = Field(
        None, description='NGSI Entity type. It has to be DataQualityAssessment'
    )
